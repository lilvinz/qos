...
/**
 * @file    STM32/USARTv2/qserial_485_lld.h
...
#define STM32_SERIAL_485_USE_UART8              FALSE
#endif
 ...
 * @note    The default is @p FALSE.
 */
#if !defined(STM32_SERIAL_485_USE_LPUART1) || defined(__DOXYGEN__)
#define STM32_SERIAL_485_USE_LPUART1            FALSE
#endif

/**
 * @brief   USART1 interrupt priority level setting.
 */
#if !defined(STM32_SERIAL_485_USART1_PRIORITY) || defined(__DOXYGEN__)
 ...
 */
#if !defined(STM32_SERIAL_485_USART3_8_PRIORITY) || defined(__DOXYGEN__)
#define STM32_SERIAL_485_USART3_8_PRIORITY      12
#endif
 ...
 */
#if !defined(STM32_SERIAL_485_UART8_PRIORITY) || defined(__DOXYGEN__)
 ...
 */
#if !defined(STM32_SERIAL_485_LPUART1_PRIORITY) || defined(__DOXYGEN__)
#define STM32_SERIAL_485_LPUART1_PRIORITY       12
#endif
/** @} */
...
#if STM32_SERIAL_485_USE_LPUART1 && !STM32_HAS_LPUART1
#error "LPUART1 not present in the selected device"
    ...
    !STM32_SERIAL_485_USE_UART7  && !STM32_SERIAL_485_USE_UART8  &&           \
    !STM32_SERIAL_485_USE_LPUART1
#error "SERIAL_485 driver activated but no USART/UART peripheral assigned"
#endif

#if STM32_SERIAL_485_USE_USART1 &&                                            \
    !OSAL_IRQ_IS_VALID_PRIORITY(STM32_SERIAL_485_USART1_PRIORITY)
#error "Invalid IRQ priority assigned to USART1"
#endif

#if STM32_SERIAL_485_USE_USART2 &&                                            \
    !OSAL_IRQ_IS_VALID_PRIORITY(STM32_SERIAL_485_USART2_PRIORITY)
#error "Invalid IRQ priority assigned to USART2"
#endif

#if STM32_SERIAL_485_USE_USART3 &&                                            \
    !OSAL_IRQ_IS_VALID_PRIORITY(STM32_SERIAL_485_USART3_PRIORITY)
#error "Invalid IRQ priority assigned to USART3"
#endif

#if STM32_SERIAL_485_USE_UART4 &&                                             \
    !OSAL_IRQ_IS_VALID_PRIORITY(STM32_SERIAL_485_UART4_PRIORITY)
#error "Invalid IRQ priority assigned to UART4"
#endif

#if STM32_SERIAL_485_USE_UART5 &&                                             \
    !OSAL_IRQ_IS_VALID_PRIORITY(STM32_SERIAL_485_UART5_PRIORITY)
...
#error "Invalid IRQ priority assigned to UART8"
    ...
    !OSAL_IRQ_IS_VALID_PRIORITY(STM32_SERIAL_485_LPUART1_PRIORITY)
